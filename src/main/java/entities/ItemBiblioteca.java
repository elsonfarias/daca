...
public class ItemBiblioteca implements Identificavel {
	...
	public ItemBiblioteca clone() {
		ItemBiblioteca clone = new ItemBiblioteca();
		clone.setId(id);
		clone.setTitulo(titulo);
		clone.setEditora(editora);
		clone.setDataPublicacao(dataPublicacao);
		clone.setDescricao(descricao);
		clone.setiSBN(iSBN);
		clone.setQuantidadePaginas(quantidadePaginas);
		clone.setAssunto(assunto);
		clone.setTags(tags);
		clone.setTipo(tipo);
